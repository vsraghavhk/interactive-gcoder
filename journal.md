...
Figure 9. Twisted form with expanding width` Figure 10. Twisted form with constant width (
layers)
...
The following are screenshots from GCodeAnalyzer for the Flask form shown above and
original cube. Figure 13 illustrates the printing settings which were used in the g-code analyzer.
Same settings were used to compare the printing time and materials used in two shapes.
Figure 13. Printing settings
The next next set of figures will illustrate the 100 layer flask and 100 layer cube side by side.
The left figures are corresponding to the flask and as the layers increase the squares are getting
smaller until the point that it reaches a predefined length limit for the shortest square. Since the
first layer was filled and wider than the shell, the screenshots below starts from the second layer
and every 10 layers there after.
Figure 13. 2nd layer


Figure 14. 12th layer
Figure 15. 22nd layer
Figure 16. 32nd layer
Figure 17. 42nd layer


Figure 18. 52nd layer
Figure 19. 62nd layer
Figure 20. 72nd layer
Figure 21. 82nd layer


Figure 22. 92nd layer
Figure 23. 100th layer
As figures above showed flask gets smaller and smaller at each layer and when it reaches the
layer 67 it hits the minimum 15 millimeter length and thereafter is just a 15mm square.
Below you can see the print time summary and filament usage for 100 layers cube and flask.
Figure 24. Cube printing summary


```
Figure 25. Flask printing summary
```
### 3-D Printing Progress and Problems
...
Figure 26 Print results of 120 layer Flask (Left) and 120 layer Twist (Right)
